...
const JoinForm = () => {
    ...
    const register = () => {
        axios
            .post('http://localhost:9000/join',
            qs.stringify(joinBody),
            joinConfig
            )
            .then((response) => {
                alert('회원가입 되었습니다.');
                            ...
                            <div className="row">
                                <div className="col-lg-12">
                                    ...
                                    <div className="checkout__input">
                                        ...
                                        <input type="text" id='passwordConfirm' name='passwordConfirm' value={passwordConfirm} onChange={onChangePasswordConfirm} class="checkout__input__add" />
                                    </div>
                                    <div className="checkout__input">
                                    ...
                                    <div style={{ width: '100%', textAlign: 'center' }}>
                                        ...
                                        <button type="submit" className="site-btn" style={{ textAlign: 'center' }} onClick={() => {
                                            register();
                                        }}>회원가입</button>
                                    </div>
...
const Postcode = ({ onChangeAddress }) => {
    ...
    return (
        <div className="checkout__input">
            ...
            <button className='site-btn cart-btn cart-btn-right' onClick={toggle}>우편번호 검색</button>
            <br />
